...
// module_5_day_1Doc.cpp: Cmodule5day1Doc 클래스의 구현
//
...
IMPLEMENT_DYNCREATE(Cmodule5day1Doc, CDocument)

BEGIN_MESSAGE_MAP(Cmodule5day1Doc, CDocument)
	ON_COMMAND(ID_SUM_CONSTANT, &Cmodule5day1Doc::OnSumConstant)
	ON_COMMAND(ID_SUB_CONSTANT, &Cmodule5day1Doc::OnSubConstant)
	ON_COMMAND(ID_MUL_CONSTANT, &Cmodule5day1Doc::OnMulConstant)
	ON_COMMAND(ID_DIV_CONSTANT, &Cmodule5day1Doc::OnDivConstant)
	ON_COMMAND(ID_AND_OPERATE, &Cmodule5day1Doc::OnAndOperate)
	ON_COMMAND(ID_OR_OPERATE, &Cmodule5day1Doc::OnOrOperate)
	ON_COMMAND(ID_XOR_OPERATE, &Cmodule5day1Doc::OnXorOperate)
	ON_COMMAND(ID_NEGA_TRANSFORM, &Cmodule5day1Doc::OnNegaTransform)
	ON_COMMAND(ID_GAMMA_CORRECTION, &Cmodule5day1Doc::OnGammaCorrection)
	ON_COMMAND(ID_BINARIZATION, &Cmodule5day1Doc::OnBinarization)
	ON_COMMAND(ID_STRESS_TRANSFORM, &Cmodule5day1Doc::OnStressTransform)
	ON_COMMAND(ID_HISTO_STRETCH, &Cmodule5day1Doc::OnHistoStretch)
	ON_COMMAND(ID_END_IN_SEARCH, &Cmodule5day1Doc::OnEndInSearch)
	ON_COMMAND(ID_HISTOGRAM, &Cmodule5day1Doc::OnHistogram)
	ON_COMMAND(ID_HISTO_EQUAL, &Cmodule5day1Doc::OnHistoEqual)
	ON_COMMAND(ID_HISTO_SPEC, &Cmodule5day1Doc::OnHistoSpec)
	ON_COMMAND(ID_EMBOSSING, &Cmodule5day1Doc::OnEmbossing)
	ON_COMMAND(ID_BLURR, &Cmodule5day1Doc::OnBlurr)
	ON_COMMAND(ID_GAUSSIAN_FILTER, &Cmodule5day1Doc::OnGaussianFilter)
	ON_COMMAND(ID_SHARPENING, &Cmodule5day1Doc::OnSharpening)
	ON_COMMAND(ID_HRF_SHARP, &Cmodule5day1Doc::OnHrfSharp)
	ON_COMMAND(ID_LRF_SHARP, &Cmodule5day1Doc::OnLrfSharp)
	ON_COMMAND(ID_DIFF_OPERATOR_HOR, &Cmodule5day1Doc::OnDiffOperatorHor)
	ON_COMMAND(ID_HOMOGEN_OPERATOR, &Cmodule5day1Doc::OnHomogenOperator)
	ON_COMMAND(ID_LAPLACIAN, &Cmodule5day1Doc::OnLaplacian)
	ON_COMMAND(ID_NEAREST, &Cmodule5day1Doc::OnNearest)
	ON_COMMAND(ID_BILINEAR, &Cmodule5day1Doc::OnBilinear)
	ON_COMMAND(ID_MEDIAN_SUB, &Cmodule5day1Doc::OnMedianSub)
	ON_COMMAND(ID_MEAN_SUB, &Cmodule5day1Doc::OnMeanSub)
	ON_COMMAND(ID_TRANSLATION, &Cmodule5day1Doc::OnTranslation)
	ON_COMMAND(ID_MIRROR_HOR, &Cmodule5day1Doc::OnMirrorHor)
	ON_COMMAND(ID_MIRROR_VER, &Cmodule5day1Doc::OnMirrorVer)
	ON_COMMAND(ID_ROTATION, &Cmodule5day1Doc::OnRotation)
	ON_COMMAND(ID_FRAME_SUM, &Cmodule5day1Doc::OnFrameSum)
	ON_COMMAND(ID_FRAME_SUB, &Cmodule5day1Doc::OnFrameSub)
	ON_COMMAND(ID_FRAME_MUL, &Cmodule5day1Doc::OnFrameMul)
	ON_COMMAND(ID_FRAME_DIV, &Cmodule5day1Doc::OnFrameDiv)
	ON_COMMAND(ID_FRAME_AND, &Cmodule5day1Doc::OnFrameAnd)
	ON_COMMAND(ID_FRAME_OR, &Cmodule5day1Doc::OnFrameOr)
	ON_COMMAND(ID_FRAME_COMB, &Cmodule5day1Doc::OnFrameComb)
	ON_COMMAND(ID_BINARY_EROSION, &Cmodule5day1Doc::OnBinaryErosion)
	ON_COMMAND(ID_BINARY_DILATION, &Cmodule5day1Doc::OnBinaryDilation)
	ON_COMMAND(ID_GRAY_EROSION, &Cmodule5day1Doc::OnGrayErosion)
	ON_COMMAND(ID_GRAY_DILATION, &Cmodule5day1Doc::OnGrayDilation)
	ON_COMMAND(ID_LOW_PASS_FILTER, &Cmodule5day1Doc::OnLowPassFilter)
	ON_COMMAND(ID_HIGH_PASS_FILTER, &Cmodule5day1Doc::OnHighPassFilter)
	ON_COMMAND(ID_MEAN_FILTER, &Cmodule5day1Doc::OnMeanFilter)
	ON_COMMAND(ID_MEDIAN_FILTER, &Cmodule5day1Doc::OnMedianFilter)
	ON_COMMAND(ID_MAX_FILTER, &Cmodule5day1Doc::OnMaxFilter)
	ON_COMMAND(ID_MIN_FILTER, &Cmodule5day1Doc::OnMinFilter)
	ON_COMMAND(ID_FFT_2D, &Cmodule5day1Doc::OnFft2d)
	ON_COMMAND(ID_IFFT_2D, &Cmodule5day1Doc::OnIfft2d)
	ON_COMMAND(ID_LPF_FREQUENCY, &Cmodule5day1Doc::OnLpfFrequency)
	ON_COMMAND(ID_HPF_FREQUENCY, &Cmodule5day1Doc::OnHpfFrequency)
END_MESSAGE_MAP()


// Cmodule5day1Doc 생성/소멸

Cmodule5day1Doc::Cmodule5day1Doc() noexcept
{
	// TODO: 여기에 일회성 생성 코드를 추가합니다.

}

Cmodule5day1Doc::~Cmodule5day1Doc()
{
}

BOOL Cmodule5day1Doc::OnNewDocument()
{
...
// Cmodule5day1Doc serialization

void Cmodule5day1Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void Cmodule5day1Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void Cmodule5day1Doc::InitializeSearchContent()
{
...
void Cmodule5day1Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
#ifdef _DEBUG
void Cmodule5day1Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void Cmodule5day1Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
BOOL Cmodule5day1Doc::OnOpenDocument(LPCTSTR lpszPathName)
{
...
BOOL Cmodule5day1Doc::OnSaveDocument(LPCTSTR lpszPathName)
{
	CFile File; // 파일 객체 선언
...
void Cmodule5day1Doc::OnDownSampling()
{
	// TODO: 여기에 구현 코드 추가.
	int i, j;
	CDownSampleDlg dlg;
...
void Cmodule5day1Doc::OnUpSampling()
{
	int i, j;
...
void Cmodule5day1Doc::OnQuantization()
{
...
void Cmodule5day1Doc::OnSumConstant()
{
...
void Cmodule5day1Doc::OnSubConstant()
{
	CConstantDlg dlg;
...
void Cmodule5day1Doc::OnMulConstant()
{
	CConstantDlg dlg;
...
void Cmodule5day1Doc::OnDivConstant()
{
	CConstantDlg dlg;
...
void Cmodule5day1Doc::OnAndOperate()
{
	CConstantDlg dlg;
	int i;
...
void Cmodule5day1Doc::OnOrOperate()
{
	CConstantDlg dlg;
	int i;
...
void Cmodule5day1Doc::OnXorOperate()
{
	CConstantDlg dlg;
	int i;
...
void Cmodule5day1Doc::OnNegaTransform()
{
	int i;
...
void Cmodule5day1Doc::OnGammaCorrection()
{
	CConstantDlg dlg;
...
void Cmodule5day1Doc::OnBinarization()
{
	CConstantDlg dlg;
...
void Cmodule5day1Doc::OnStressTransform()
{
...
void Cmodule5day1Doc::OnHistoStretch()
{
	int i;
...
void Cmodule5day1Doc::OnEndInSearch()
{
	int i;
	unsigned char LOW, HIGH, MAX, MIN;
...
void Cmodule5day1Doc::OnHistogram()
{
	// 히스토그램의 값은 0~255
...
void Cmodule5day1Doc::OnHistoEqual()
{
	int i, value;
...
void Cmodule5day1Doc::OnHistoSpec()
{
...
void Cmodule5day1Doc::OnEmbossing()
{
	int i, j;
...
double** Cmodule5day1Doc::OnMaskProcess(unsigned char *Target, double Mask[3][3])
{ // 회선 처리가 일어나는 함수
		int i, j, n, m;
...
double** Cmodule5day1Doc::OnScale(double **Target, int height, int width)
{ // 정규화를 위한 함수
	int i, j;
	double min, max;
...
double** Cmodule5day1Doc::Image2DMem(int height, int width)
{ // 2차원 메모리 할당을 위한 함수
	double** temp;
	int i, j;
...
void Cmodule5day1Doc::OnGaussianFilter()
{
	int i, j;
...
void Cmodule5day1Doc::OnSharpening()
{
	int i, j;
...
void Cmodule5day1Doc::OnHrfSharp()
{
	int i, j;
...
void Cmodule5day1Doc::OnLrfSharp()
{
...
void Cmodule5day1Doc::OnDiffOperatorHor()
{
	int i, j;
...
void Cmodule5day1Doc::OnHomogenOperator()
{
	int i, j, n, m;
...
double Cmodule5day1Doc::DoubleABS(double X)
{ // 실수의 절대 값 연산 함수
	if (X >= 0)
		return X;
	else
...
void Cmodule5day1Doc::OnLaplacian()
{
	int i, j;
...
void Cmodule5day1Doc::OnNearest()
{
	CConstantDlg dlg;
	int i, j;
	int ZoomRate; // 영상 확대 배율
	double **tempArray;
...
void Cmodule5day1Doc::OnBilinear()
{
...
void Cmodule5day1Doc::OnMedianSub()
{
...
void Cmodule5day1Doc::OnBubleSort(double *A, int MAX)
{
	// 데이터의 정렬을 처리하는 함수
	int i, j;
	for (i = 0; i < MAX; i++) {
...
void Cmodule5day1Doc::OnSwap(double *a, double *b)
{
	// 데이터 교환 함수
	double temp;
	temp = *a;
...
void Cmodule5day1Doc::OnMeanSub()
{
...
void Cmodule5day1Doc::OnTranslation()
{
	int i, j;
...
void Cmodule5day1Doc::OnMirrorHor()
{
	int i, j;
...
void Cmodule5day1Doc::OnMirrorVer()
{
	int i, j;
...
void Cmodule5day1Doc::OnRotation()
{
...
void Cmodule5day1Doc::OnFrameSum()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void Cmodule5day1Doc::OnFrameSub()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void Cmodule5day1Doc::OnFrameMul()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void Cmodule5day1Doc::OnFrameDiv()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void Cmodule5day1Doc::OnFrameAnd()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
	int i;
...
void Cmodule5day1Doc::OnFrameOr()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
	int i;
...
void Cmodule5day1Doc::OnFrameComb()
{
	CFile File;
	CFileDialog OpenDlg(TRUE);
	int i;
...
void Cmodule5day1Doc::OnBinaryErosion()
{
	int i, j, n, m;
...
void Cmodule5day1Doc::OnBinaryDilation()
{
	int i, j, n, m;
...
void Cmodule5day1Doc::OnGrayErosion()
{
	int i, j, n, m, h;
...
void Cmodule5day1Doc::OnGrayDilation()
{
	int i, j, n, m, h;
...
void Cmodule5day1Doc::OnLowPassFilter()
{
	int i, j;
...
void Cmodule5day1Doc::OnHighPassFilter()
{
	int i, j;
...
void Cmodule5day1Doc::OnMeanFilter()
{
	int i, j, n, m;
...
void Cmodule5day1Doc::OnMedianFilter()
{
	int i, j, n, m, index = 0;
...
void Cmodule5day1Doc::OnMaxFilter()
{
	int i, j, n, m, index = 0;
	double **tempInputImage, Mask[9];
...
void Cmodule5day1Doc::OnMinFilter()
{
	int i, j, n, m, index = 0;
	double **tempInputImage, Mask[9];
...
void  Cmodule5day1Doc::OnFft1d(Complex *X, int N, int Log2N)
{
	// 1차원 fft를 위한 함수
	OnShuffle(X, N, Log2N); // 함수 호출
	OnButterfly(X, N, Log2N, 1); // 함수 호출
}
void  Cmodule5day1Doc::OnShuffle(Complex *X, int N, int Log2N)
{
...
void  Cmodule5day1Doc::OnButterfly(Complex *X, int N, int Log2N, int mode)
{
...
int  Cmodule5day1Doc::OnReverseBitOrder(int index, int Log2N)
{
	int i, X, Y;
	Y = 0;
...
void Cmodule5day1Doc::OnIfft1d(Complex *X, int N, int Log2N)
{
	OnShuffle(X, N, Log2N);
	OnButterfly(X, N, Log2N, 2);
}

void Cmodule5day1Doc::OnLpfFrequency()
{
	int i, j, x, y;
	double temp, D, N;
	D = 32.0;
...
void Cmodule5day1Doc::OnHpfFrequency()
{
	int i, j, x, y;
	double temp, D, N;
	D = 128.0;
